...
output_male = '/data/stars/share/celeba_hq/male_anon'
...
def main(args):
    ...
    # ---------------------------------------------------
    log_file = os.path.join('/home/aegin/projects/anonymization/AnonNET/stats_and_jobs_celeba', f"processing_summary_male_celeba_{args.even}.txt")
