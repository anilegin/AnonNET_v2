...
celeba_male_train = '/data/stars/share/celeba_hq/train/male'
celeba_male_val = '/data/stars/share/celeba_hq/val/male'
output_male = '/data/stars/share/celeba_hq/male_anon_abl'
...
def main(args):
    ...
    all_videos = get_all_videos(celeba_male_train)
    ...
    valid_paths_list = filter_processed_videos(all_videos, output_male)
    ...
    # ---------------------------------------------------
    log_file = os.path.join('/home/aegin/projects/anonymization/AnonNET/stats_and_jobs_celeba_abl', f"processing_summary_male_celeba_{args.even}.txt")
    ...
    for vid_path in tqdm(valid_paths_list, desc="Anon_video"):
        try:
            ...
            existing_outputs = os.listdir(output_male)

            # inside the loop, after defining video_name
            if any(fname.startswith(f"{video_name}_anon_") for fname in existing_outputs):
            ...
            save_p = os.path.join(output_male, f"{video_name}_anon_{filename_info}.png")
...
#     # ---------------------------------------------------
#     all_videos = get_all_videos(celeba_male_train)
#     all_videos = all_videos.extend(get_all_videos(celeba_male_val))
...
#     all_videos = filter_processed_videos(all_videos, output_male)
...
#             save_p = os.path.join(output_male, f"{video_name}_anon_nodet.png")
#             out_image.save(save_p)
#             continue
