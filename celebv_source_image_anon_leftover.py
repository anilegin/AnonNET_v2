...
celebv_anon = '/data/stars/share/CelebV_HQ_Anon/train_anon_final_im'
...
def main(args):
    ...
    # if args.even == 1:
    #     all_videos = all_videos[0::8]
    # elif args.even == 2:
    #     all_videos = all_videos[1::8]
    # elif args.even == 3:
    #     all_videos = all_videos[2::8]
    # elif args.even == 4:
    ...
    # ---------------------------------------------------
    log_file = os.path.join('/home/aegin/projects/anonymization/AnonNET/stats_and_jobs_celebv_video', f"processing_summary_celebv_{args.even}.txt")
    ...
    for idx, vid_path in enumerate(tqdm(valid_paths_list, desc="Anon_video")):
        try:
            ...
            print('frontal has been found')  
            frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
            frame_pil = Image.fromarray(frame)
            vid_path = os.path.join(celebv_source, f"{video_name}_source.png")
            frame_pil.save(vid_path)
