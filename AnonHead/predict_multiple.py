...
class Predictor:
    ...
    def create_prompt(self, im_path: str, deepface_result: dict = None) -> str:
        """
        Takes a path to image and single DeepFace analyze output (as a dictionary)
    ...
    def predict(
        ...
        if prompt == "" or None:
            prompt = self.create_prompt(im_path)
    ...
    def anonymize(
        ...
        out_image, init_image = self.predict(**params)
